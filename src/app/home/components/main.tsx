         ...
         <div className="flex flex-row">
              <div className="flex w-7/12 flex-col">
                ...
                >
                  ...
                  <div className="ml-8 -mt-2 text-white text-[15px] text-opacity-60 font-">
                    24-26th January
                  </div>
                  <div className="w-full h-[1px] mt-5 bg-gradient-to-r from-transparent via-custom to-transparent"></div>
                  <div className="mt-2 ml-8 text-white text-[14px]">REALMS OF ENGINEERING MARVELS</div>
                </motion.div>
              </div>
              <motion.div
...
<AnimatedTestimonials testimonials={testimonials} />
            ...
            <div className="pt-10 flex justify-around flex-row">
              <div className="w-5/12 h-[150px] border-2 rounded-2xl flex flex-col">
                <div className="mt-5 mx-auto rounded-full bg-custom w-12 h-12 "></div>
                <div className="mt-5 mx-auto text-white"> <a href='/events'>EVENTS </a></div>
              ...
              <div className="w-5/12 h-[150px] border-2 rounded-2xl flex flex-col">
                <div className="mt-5 mx-auto rounded-full bg-custom w-12 h-12 "></div>
                <div className="mt-5 mx-auto text-white">  <a href='/workshop'> WORKSHOPS      </a></div>
                <div className="w-full h-[1px] mt-3 bg-gradient-to-r from-transparent via-custom to-transparent"></div>
              </div>
