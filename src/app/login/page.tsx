...
const LoginPage: React.FC = () => {
  return (
    <div className="bg-black min-h-screen relative">
      ...
      <div className=" text-white text-3xl font-normal pt-10 px-7 text-left">
        LOGIN
      </div>

      <div
        className="p-4 mx-2 mt-12 rounded-3xl opacity h-[550px] flex flex-col justify-center items-center transition-all duration-300 ease-in-out transform"
        style={{
          background:
      ...
      >
        ...
        <div className="text-white mt-[18px] text-[16px] font-sans"> Do not  have an account.Sign Up</div>
      </div>
    </div>
  );
};
